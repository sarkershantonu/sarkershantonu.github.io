...
comments: true
---
In this article we are going to see how can we apply [**Java Threading**](/2015/10/08/java-thread-use/). This is very basic without Executor service. We can apply threading in two ways.
