...
In out testing world, we need this pattern in very crucial way. Suppose we are designing reporting system, and we need to report/log state of the object after a certain time or any change of the object. 

I even use that as trigger for another set of operation on change of the subject(object). 
