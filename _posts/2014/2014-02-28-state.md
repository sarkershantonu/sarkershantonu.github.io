...
# Example : 
Let's consider an android mobile connecting to PC. We will represent an Android mobile as Context object(we may apply interface also that will be called from client). We have mainly three states( three way to connect a device to PC)
