...
##### Note 
There are lot more regular feature and experimental features I skipped due to not scope of my tests(spatially @Synchronized) . I will add other one by one in github repository and add reference notes here.
